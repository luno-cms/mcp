...
| **Smithery** | Live listing (copy updated 2026-09-22) | [`smithery.ai/servers/sattela3/luno`](https://smithery.ai/servers/sattela3/luno) — Arcade URL. Old [`@luno-cms/mcp`](https://smithery.ai/server/@luno-cms/mcp) is 404. Display name is `LUNO — AI-era Backend Platform`. Description has four operators, crypto/meetluno.ai, and `npx -y @luno-cms/mcp setup`. Namespace stays `sattela3/luno` (not `@luno-cms/mcp`). Hosted toolbox `mcp.smithery.ai/s-koba` is personal, not the directory surface. |
| **mcpservers.org** | Live + free update queued 2026-09-22 | [`mcpservers.org/servers/luno-rest`](https://mcpservers.org/servers/luno-rest) (JA: [`/ja/servers/luno-rest`](https://mcpservers.org/ja/servers/luno-rest)) — same listing, not a second page. Current live page still scrapes `luno.rest` (3 operators, `npx` without `-y`, docs = luno.rest). Free submit 2026-09-22 asked them to **update** that page: name `LUNO — AI-era Backend Platform`, category Development, four operators + crypto/meetluno + `npx -y`, repo `github.com/luno-cms/mcp`, registry `io.github.luno-cms/mcp`. Review ≤ 2 weeks; mail to s-koba@commonld.com. Did not pay $39. Did not check remote. |
...
| **Test B baseline** | Re-run 2026-09-22: still all No | [`phase2-ai-discovery-baseline.md`](https://github.com/luno-cms/marketing/blob/main/docs/phase2-ai-discovery-baseline.md) — Formal After 2026-09-22. Isolated web search, same prompt. First choice Sanity + Supabase. LUNO never appeared. |
